        ...
        <main className="z-50 flex w-full flex-col items-center justify-center gap-8 md:flex-row md:gap-24">
          <div className="w-full max-w-[450px] text-center md:w-[50%] md:text-left">
            <div className="mb-6 flex items-center justify-center text-3xl font-semibold md:justify-start">
              <Image src={LOGO_URL} alt="Kriya" width={60} height={60} className="mr-3 rounded-[14px] border border-gray-200 shadow-sm" />
              <span className="font-instrument font-medium italic tracking-normal">kriya</span>
            </div>
            ...
            <p className="mb-6 text-base leading-relaxed text-gray-600">
              <span className="rounded-lg bg-amber-100 px-2 py-1 font-instrument text-xl font-extrabold italic tracking-normal">kriya</span> blends timeless wisdom from the Gita with modern design to help you act with clarity.
      ...
      <section className="mt-16 px-6">
        <div className="mx-auto max-w-[700px] selection:bg-cyan-200 selection:text-purple-900">
          ...
          <div className="space-y-4 leading-relaxed text-gray-700">
            ...
            <p className="font-semibold italic text-cyan-800"><span className="font-instrument text-xl font-semibold">kriya</span> means action.</p>
            ...
            <p>That&apos;s what <span className="font-instrument text-xl font-semibold italic">kriya</span> stands for: bringing the wisdom of the Gita into the most actionable phase of your life. To not just read it, but to live it as you take on your own daily battles.</p>
          </div>
        </div>
      </section>
